...
export default function FeaturesSection() {
  return (
    <section className=" px-10 py-11 bg-[#FE7CAE] text-[#261F22]">
      {/* <div className="flex absolute mt-10">
<div className="w-80 h-80 border-2 hover:hidden border-amber-300 transform-3d rotate-45 "></div>
<div className="w-80 h-80 border-2 hover:hidden border-amber-300 transform-3d rotate-45 "></div>
<div className="w-80 h-80 border-2 hover:hidden border-amber-300 transform-3d rotate-45 "></div>
      </div> */}
      ...
      <div className=" flex justify-center content-center flex-col items-center">
        <div className=" max-w-3xl mx-auto text-center mb-5">
          <h2 className="text-3xl md:text-4xl font-bold mb-2">Key Features</h2>
